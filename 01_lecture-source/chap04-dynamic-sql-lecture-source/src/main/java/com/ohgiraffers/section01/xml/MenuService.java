...
public class MenuService {
    ...
    public void selectMenuByPrice(int price) {
        ...
        /* 필기. 기본 자료형으로는 조건문의 값을 비교할 수 없으면 hashmap 의 key
    ...
    public void searchMenuByRandomMenuCode(List<Integer> randomMenuCodeList) {
        ...
        if (menuList != null && menuList.size() > 0) {
            ...
            System.out.println("검색 결과가 존재하지 않습닏나...");
        }
    ...
    public void modifyMenu(Map<String, Object> criteria) {
        ...
        //DML  구문 update,delete,insert 트랜젝션 제어 필요(commit.rollback)
        ...
        if (result > 0){
            ...
            System.out.println("메뉴 정보 변경에 실패하였습니다... ㅜㅜ");
            sqlSession.rollback();
        }
        sqlSession.close();
