...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.print("메뉴 관리 번호를 입려해주세요 : ");
            int no = sc.nextInt();
...
//                case  5 : menuController.deleteMenu(inputMenuCode()); break;
    ...
    private static Map<String,String> inputEdit() {
        ...
        Map<String,String> parameter = new HashMap<>();    // Map HashMap => 다형성
    ...
    private static Map<String , String> inputMenuCode() {
        ...
        return parameter;   // 만약4를 입력하면 key = code value = 4
